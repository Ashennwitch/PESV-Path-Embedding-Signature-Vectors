...
INPUT_DIR = '/content/drive/MyDrive/1 Skripsi/Dataset/ISCX-VPN-NonVPN-2016/split_flows_final'


# Directory where the final cleaned pcap files will be saved (~8.7k flows)
OUTPUT_DIR = '/content/drive/MyDrive/1 Skripsi/Dataset/ISCX-VPN-NonVPN-2016/cleaned_flows_final'
